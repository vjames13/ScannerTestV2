...
namespace ZXing
{
   ...
   public class BarcodeReader : BarcodeReader<Bitmap>, IBarcodeReader
   {
      ...
      public BarcodeReader(Reader reader,
         ...
         Func<LuminanceSource, Binarizer> createBinerizer = null
      )
         : base(reader, createLuminanceSource ?? defaultCreateLuminanceSource)
      {
      }
      ...
      public BarcodeReader(Reader reader,
         ...
         : base(reader, createLuminanceSource ?? defaultCreateLuminanceSource, createRGBLuminanceSource)
      {
      }
   }
}
